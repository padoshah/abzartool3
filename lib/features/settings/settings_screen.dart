            ...
            ListTile(
              ...
              trailing: DropdownButton<ThemeMode>(
                ...
                onChanged: (value) => controller
                    .update((_) async => settings.copyWith(themeMode: value)),
              ),
            ),
            ListTile(
              ...
              trailing: DropdownButton<String>(
                ...
                onChanged: (value) => controller.update((_) async =>
                    settings.copyWith(
                        locale: value == 'system' ? null : Locale(value!),
                        clearLocale: value == 'system')),
              ),
            ),
            ListTile(
              ...
              subtitle: Slider(
                ...
                onChanged: (value) => controller.update(
                    (_) async => settings.copyWith(defaultDpi: value.toInt())),
              ),
            ),
            ListTile(
              ...
              subtitle: Slider(
                ...
                onChanged: (value) => controller.update((_) async =>
                    settings.copyWith(defaultQuality: value.toInt())),
              ),
            ),
            ListTile(
              title: Text(l10n.outputDirectory),
              subtitle: settings.outputDirectory == null
                  ? null
                  : Text(settings.outputDirectory!),
              trailing: const Icon(Icons.folder_open),
              onTap: () async {
                final result = await FilePicker.platform.getDirectoryPath();
                if (result != null)
                  controller.update(
                      (_) async => settings.copyWith(outputDirectory: result));
              },
            ),
            SwitchListTile(
              ...
              onChanged: (value) => controller
                  .update((_) async => settings.copyWith(checkUpdates: value)),
            ),
            ListTile(
                title: Text(l10n.checkNow),
