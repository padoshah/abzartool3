      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: running ? null : save,
          ),
          IconButton(
            tooltip: l10n.search,
            icon: const Icon(Icons.search),
            onPressed: running ? null : searchText,
          ),
        ],
      ),
      body: Row(
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => Card(
                child: AspectRatio(
                  aspectRatio: .7,
                  child: Center(child: Text('${l10n.documents} 1')),
                ),
              ),
            ),
          ),
                ...
                Wrap(
                  children: <Widget>[
                    IconButton(
                      ...
                      onPressed: () => setState(() => text.text += '\n• '),
                    ),
                    IconButton(
                      tooltip: l10n.esign,
                      icon: const Icon(Icons.draw),
                      onPressed: () => context.push('/esign'),
                    ),
                    IconButton(
                      tooltip: l10n.rotate,
